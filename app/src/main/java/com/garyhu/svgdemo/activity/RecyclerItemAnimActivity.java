...
import com.garyhu.svgdemo.bean.StockEntity;
import com.garyhu.svgdemo.utils.Utils;
import com.garyhu.svgdemo.view.recyclermanager.VegaLayoutManager;
...
public class RecyclerItemAnimActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (immerse) {
            Log.d("garyhu","positionView == "+positionView);
